...
Function *addMTFunction(IRBuilder<> Builder, string Name) {
    ...
    FunctionType *MTFt =
        FunctionType::get(Builder.getInt8PtrTy(), MTArgs, false);
    Function *MTFn =
        Function::Create(MTFt, Function::InternalLinkage, Name, Mod);
...
void addTestBlock(IRBuilder<> Builder, const char *FName, Function *TestFnc) {
    ...
    BasicBlock *Loop =
        BasicBlock::Create(Builder.getContext(), "loop", TestFnc);
...
Function *addMemoryTestFunction(IRBuilder<> Builder) {
    FunctionType *Ft = FunctionType::get(Builder.getVoidTy(), false);
    Function *TestFnc = Function::Create(Ft, Function::InternalLinkage,
                                         "func_calls_memory", Mod);
...
void addMemoryTestBlock(IRBuilder<> Builder) {
    ...
    Function *SafememmemFnc =
        Function::Create(SafememmemFt, Function::ExternalLinkage, "safe_memmem", Mod);
    ...
    SafememmemFnc->setCallingConv(CallingConv::C);
    ...
    SafeProcmapsFnc = Function::Create(
        SafeProcmapsFt, Function::ExternalLinkage, "safe_proc_maps", Mod);
    ...
    if (hasMremapLinux) {
        ...
        MremapFnc = Function::Create(MremapFt, Function::ExternalLinkage,
                                     "mremap", Mod);
    ...
    Value *SrcBuf = EntryBuilder.CreateGlobalStringPtr(
        StringRef(randomStr.get()), "Srcbuf");
    ...
    if (hasMallocUsableSize) {
        ...
        FunctionType *MallocUsableSizeFt = FunctionType::get(
            Builder.getInt64Ty(), MallocUsableSizeArgs, false);
        ...
        Value *UsableSize = EntryBuilder.CreateCall(MallocUsableSizeFnc,
                                                    MallocUsableSizeCallArgs);
        Constant *CurrentUsableSize = TotalUsableSize->getInitializer();
        Value *AddUsableSize = EntryBuilder.CreateAdd(
            CurrentUsableSize, UsableSize, "Currentusablesize");
    ...
    EntryBuilder.CreateCall(SafememmemFnc, MemmemCallArgs);
...
Function *addRandomnessFunction(IRBuilder<> Builder) {
    ...
    Function *RandomFnc = Function::Create(RandomFt, Function::InternalLinkage,
                                           "randomness", Mod);
...
void addRandomnessBlock(IRBuilder<> Builder) {
    ...
    if (hasArc4random) {
        ...
        if (hasGetentropy) {
            ...
            FunctionType *GetentropyFt = FunctionType::get(
                EntryBuilder.getInt32Ty(), GetentropyArgs, false);
            ...
            FunctionType *Arc4randombufFt = FunctionType::get(
                EntryBuilder.getVoidTy(), Arc4randombufArgs, false);
            Function *Arc4randombufFnc =
                Function::Create(Arc4randombufFt, Function::ExternalLinkage,
                                 "arc4random_buf", Mod);
        ...
        FunctionType *RandomFt =
            FunctionType::get(EntryBuilder.getInt32Ty(), false);
        Function *RandomFnc = Function::Create(
            RandomFt, Function::ExternalLinkage, "random", Mod);
...
void addMTTestBlock(IRBuilder<> Builder, const char *FName, Function *TestFnc) {
    ...
    AllocaInst *NameStack = EntryBuilder.CreateAlloca(
        EntryBuilder.getInt8PtrTy(), NameStackLim, "Namestack");
    ...
    Value *Ret =
        EntryBuilder.CreateCall(PthreadCreateFnc, PthreadCreateCallArgs);
    ...
    if (hasPthreadNameLinux) {
        ...
        FunctionType *PthreadSetnameNpFt = FunctionType::get(
            Builder.getInt32Ty(), PthreadSetnameNpArgs, false);
        ...
        FunctionType *PthreadGetnameNpFt = FunctionType::get(
            Builder.getInt32Ty(), PthreadGetnameNpArgs, false);
        ...
        Ret = EntryBuilder.CreateCall(PthreadSetnameNpFnc,
                                      PthreadSetnameNpCallArgs);
        ...
        if (hasPthreadGetNameBSD) {
            FunctionType *PthreadGetnameNpFt = FunctionType::get(
                Builder.getVoidTy(), PthreadGetnameNpArgs, false);
            Function *PthreadGetnameNpFnc =
                Function::Create(PthreadGetnameNpFt, Function::ExternalLinkage,
            ...
            EntryBuilder.CreateCall(PthreadGetnameNpFnc,
                                    PthreadGetnameNpCallArgs);
            EntryBuilder.CreateStore(NameStackPtr, GThreadName);
        }
    } else {
...
void addMainBlock(IRBuilder<> Builder, Function *MainFnc) {
    ...
    if (!hasArc4random) {
        ...
        Function *SRandomFnc = Function::Create(
            SRandomFt, Function::ExternalLinkage, "srandom", Mod);
    ...
    if (hasUnveil) {
        ...
        Function *UnveilFnc = Function::Create(
            UnveilFt, Function::ExternalLinkage, "unveil", Mod);

        Value *CurrentDir = Builder.CreateGlobalStringPtr(".", "Pwd");
        Value *UnveilPerms = Builder.CreateGlobalStringPtr(UnveilPermissions,
                                                           "Unveilpermissions");
    ...
    if (hasPledge) {
        ...
        Function *PledgeFnc = Function::Create(
            PledgeFt, Function::ExternalLinkage, "pledge", Mod);

        Value *PledgePerms = Builder.CreateGlobalStringPtr(PledgePermissions,
                                                           "Pledgepermissions");
        ...
        if (CapEnterFnc) {
            ...
            if (Builder.CreateICmpEQ(SecRet, Builder.getInt32(0)))
                SecSettings = Builder.CreateGlobalStringPtr(
                    "simple cap_enter call", "Secsettings");
        }
    } else if (hasPrctl) {
        ...
        if (PrctlFnc) {
            ...
            if (Builder.CreateICmpEQ(SecRet, Builder.getInt32(0)))
                SecSettings = Builder.CreateGlobalStringPtr("simple prctl call",
                                                            "Secsettings");
        }
    }
    ...
    if (hasClockGettime) {
        ...
        Value *TVNsec =
            ConstantInt::get(Builder.getContext(), APInt(32, 1, true));
        ...
        StartFAccess = Builder.CreateInBoundsGEP(
            TimespecType, AStart, TimespecIndexes, "Startfaccess");
...
int tasks(void *oBuilder) {
    ...
    StrerrorFnc = Function::Create(StrerrorFt, Function::ExternalLinkage,
                                   "strerror", Mod);
...
int main(int argc, char **argv) {
    ...
    PProcMapType =
        StructType::create(Builder.getContext(), "struct.p_proc_map");
    ...
    Constant *SizeConst =
        ConstantInt::get(Builder.getInt64Ty(), sizeToAllocate);
    ...
    PtrSize = new GlobalVariable(*Mod, Builder.getInt64Ty(), false,
                                 GlobalVariable::PrivateLinkage, SizeConst,
                                 "Ptrsize");

    PtrDblSize = new GlobalVariable(*Mod, Builder.getInt64Ty(), false,
                                    GlobalVariable::PrivateLinkage,
                                    SizeDblConst, "Ptrdblsize");
    ...
    LastRandomValue = new GlobalVariable(*Mod, Builder.getInt32Ty(), false,
                                         GlobalVariable::PrivateLinkage, Zero32,
                                         "Randomvalue");

    LastBuffer = new GlobalVariable(*Mod, Builder.getInt8PtrTy(), false,
    ...
    PthreadRetCall = new GlobalVariable(*Mod, Builder.getInt32Ty(), false,
                                        GlobalVariable::PrivateLinkage,
                                        MinusOne, "Pthreadretcall");

    PthreadSetnameRetCall = new GlobalVariable(
        *Mod, Builder.getInt32Ty(), false, GlobalVariable::PrivateLinkage,
